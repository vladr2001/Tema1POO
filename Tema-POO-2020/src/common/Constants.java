...
public final class Constants {
    ...
    public static final String FAVERRDUPLICATE2 = " is already in favourite list";
    public static final String FAVERRINVALID1 = "error -> ";
    public static final String FAVERRINVALID2 = " is not seen";
    public static final String SUCCESS = "success -> ";
    public static final String FAVSUCCESS2 = " was added as favourite";
    public static final String VIEWSUCCESS = " was viewed with total views of ";
    public static final String RATESUCCESS1 = " was rated with ";
    public static final String RATESUCCESS2 = " by ";
    ...
    public static final int MAGICNUMBER = 3;
    ...
    public static final String FAVRECOM = "favorite_recom";
    public static final String RATINGSRECOM = "ratings_recom";
}
